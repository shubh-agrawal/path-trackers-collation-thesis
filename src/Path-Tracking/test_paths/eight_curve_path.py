...
'''
eight_curve.py
This code publishes a static eight shape path in the form of an array for the bot to follow.
...
def main():
	...
	for t in frange(0, 2 * math.pi, resolution):
		x = 70 * math.sin(t) + int(offset_x)
		y = 50 * math.sin(t) * math.cos(t) + int(offset_y)
		if has_initialize:
			old_x = x
			old_y = y
