...
# Subscribe Topic: odometry/filtered1, astroid_path

# maximum linear velocity
global steer
k = 1.0 # constant for relating look ahead distance and velocity
wheelbase = 1.958 # wheel base for the vehicle
...
def callback_feedback(data):
	...
	cmd.angular.z = min(40, max(-40, steer_angle * 180 / math.pi))
...
def callback_tar_vel(data):

	global max_vel # max velocity
	max_vel = data.linear.x*(5.0/18)
...
def start():
	...
	#for mahindra
	rospy.Subscriber("cmd_vel", Twist, callback_tar_vel)
