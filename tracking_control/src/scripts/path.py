...
'''
path.py
This code publishes a static path in the form of an array for the bot to follow.
...
def main():
	...
	update_rate = rospy.get_param('~update_rate', 2.5) # rate of path publishing
	has_initialize = True
